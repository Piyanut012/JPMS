...
public class CustomerInfo_GUIlast extends JInternalFrame {
    ...
    private Customer customer_current;
    private LinkedHashMap<Integer, Pawn> itmes_data;
    private JPanel panelContainer;
    
    public CustomerInfo_GUIlast() {
...
////-------*******************
    ...
    public void Search(String kw){
        ...
        try{
            ...
            customer_current = MainGUI.getInfo().getCustomers_Data().get(keyword);
            nameLb.setText("Name : " + customer_current.getName());
            telLb.setText("Phone Number : " + customer_current.getPhone_number());
            adrsLb.setText("Address : " + customer_current.getAddress());
            mailLb.setText("E-mail : " + customer_current.getEmail());
//        mnyLb.setText("Money : " + customer);

            //Set Pawned Item
            panelContainer.removeAll();
            System.out.println("Yes");
            itmes_data = customer_current.getItmes_data();
